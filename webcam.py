...
class WebCam:
    ...
    def as_dict(self):
        ...
        # Fluidd 1.30 filters cameras by `enabled === true`; this Moonraker
        # build predates the `enabled` field so it gets filtered out by
        # default. Inject it here so config-managed cameras show up.
